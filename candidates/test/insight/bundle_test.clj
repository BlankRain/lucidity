(ns lucid.insight.bundle-test
  (:use hara.test)
  (:require [lucid.insight.bundle :refer :all]))

^{:refer lucid.insight.bundle/pack :added "0.1"}
(fact "converts sniper forms into lucid.insight compatible forms")

^{:refer lucid.insight.bundle/keywordize-entries :added "0.1"}
...
^{:refer lucid.insight.bundle/bundle :added "0.1"}
...
(comment (defonce hara (bundle/bundle [#"src/hara"]))
         ...
         (defonce lucid.insight (bundle/bundle [#"src/lucid.insight"]))
