(ns lucid.graph.draw.dom-test
  (:use hara.test)
  (:require [lucid.graph.draw.dom :refer :all]
...
^{:refer lucid.graph.draw.dom/make-patch-element :added "0.1"}
(fact "creates an entry for patching a element"
  (make-patch-element {} :nodes :a :+)
  => {:nodes {:+ #{:a}}})

^{:refer lucid.graph.draw.dom/make-patch-attributes :added "0.1"}
...
^{:refer lucid.graph.draw.dom/make-patch :added "0.1"}
...
^{:refer lucid.graph.draw.dom/diff-dom :added "0.1"}
...
^{:refer lucid.graph.draw.dom/set-dom :added "0.1"}
